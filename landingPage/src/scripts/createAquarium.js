...
export function createAquarium() {
  ...
  toggleButton.innerHTML = "Toggle Fish Menu";
  ...
  badFish.addEventListener("click", () => {
    ...
    function detectCollisions() {
      ...
      overlappingFish.forEach((overlappingFish) => {
        ...
        clickableDivs = clickableDivs.filter(
          (fish) => fish !== overlappingFish
        );
